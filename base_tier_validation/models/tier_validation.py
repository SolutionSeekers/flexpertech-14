...
class TierValidation(models.AbstractModel):
    ...
    def _get_sequences_to_approve(self, user):
        ...
        approve_sequences = my_reviews.filtered(
            "approve_sequence").mapped("sequence")
    ...
    def _get_under_validation_exceptions(self):
        ...
        return ["message_follower_ids", "access_token", "incoterm_id", "partner_ref", "partner_id", "currency_id", "date_order", "date_planned", "user_id", "picking_type_id", "payment_term_id", "fiscal_position_id", ]
